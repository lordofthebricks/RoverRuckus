...
@Autonomous (name = "Program_Maybe")
@Disabled
public class Program_Maybe extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        /*blinkinLedDriver.setPattern(patternSM);
        blinkinLedDriver.setPattern(patternGM);*/

       /* display = telemetry.addData("Display Kind: ", displayKind.toString());
        patternName = telemetry.addData("Pattern: ", patternSM.toString());
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Gold",robot.colorSensor.green()-robot.colorSensor.blue());
...
*/
      ...
      /*  relativeLayout.post(new Runnable() {
        ...
        if (robot.colorSensor.equals(Color.YELLOW)) {
    ...
    protected void setDisplayKind(Blinky.DisplayKind displayKind)
    {
