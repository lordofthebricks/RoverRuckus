...
@Autonomous(name = "EncoderTestlfuteplayer1010101010101")
@Disabled
public class LOTBAutonomousEncoders extends LinearOpMode
{
    ...
    LOTBHardware robot = new LOTBHardware();  //changed math.pi to 3.14159265
    ElapsedTime runtime = new ElapsedTime();
    public void runOpMode() throws InterruptedException{
        encoderDrive(.3,12,12,12,12,3.0);
        encoderDrive(.3,12,-12,12,-12,3);
        encoderDrive(.3,-12,-12,-12,-12,3);
        encoderDrive(.3,-12,12,-12,12,3);
        encoderDrive(.3,12,12,12,12,3);
        encoderDrive(.3,0,12,0,12,3);
        encoderDrive(.3,12,0,12,0,3);
        encoderDrive(.3,0,-12,0,-12,3);
        encoderDrive(.3,-12,0,-12,0,3);
    }
