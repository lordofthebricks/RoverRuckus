...
@Autonomous(name = "ToMineralRealBlackArrow")
@Disabled
public class tomineralsrealBLKARW extends LinearOpMode
{

    //int Coor = Math.round()
    BLKARWHardware robot = new BLKARWHardware();
    ...
    public void runOpMode()throws InterruptedException{
       ...
       // telemetry.addData("1 imu heading", lastAngles.firstAngle);
        ...
        robot.Left_Motor.setPower(-power + correction);
        robot.Right_Motor.setPower(-power);
    ...
    public void GoToCoordinates(int Coordinates, int Angle){
        ...
        int newRBPosition = robot.Right_Motor.getCurrentPosition() + (Coordinates);
        int newLTPosition = robot.Left_Motor.getCurrentPosition() + (Coordinates);
        robot.Right_Motor.setTargetPosition(newRBPosition);
        robot.Left_Motor.setTargetPosition(newLTPosition);
        robot.Right_Motor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robot.Left_Motor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robot.Right_Motor.setPower(-.6);
        robot.Left_Motor.setPower(-.6);
    ...
    robot.Right_Top.setPower(-.6);*/
        while (angles.firstAngle < Angle){
            robot.Left_Motor.setPower(power);
            robot.Right_Motor.setPower(-power);
        } while (angles.firstAngle > Angle){
            robot.Left_Motor.setPower(-power);
            robot.Right_Motor.setPower(power);
