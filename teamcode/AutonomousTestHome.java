...
@Autonomous (name = "AutonomousTestHome")
@Disabled
public class AutonomousTestHome extends LinearOpMode
{
    ...
    private void initTfod() {
        ...
        robot.tfod.loadModelFromAsset(TFOD_MODEL_ASSET, LABEL_GOLD_MINERAL, LABEL_SILVER_MINERAL);
    }
