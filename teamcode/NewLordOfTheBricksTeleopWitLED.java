...
@TeleOp(name = "NewTeleopWitLED")
public class NewLordOfTheBricksTeleopWitLED extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()){
            ...
            if ((robot.RightDistanceSensor.getDistance(DistanceUnit.INCH)) <= 2.5 && (robot.LeftDistanceSensor.getDistance(DistanceUnit.INCH)) <= 2.5) {
                ...
                if (robot.RightColorSensor.green() - robot.RightColorSensor.blue() <= 450 && robot.LeftColorSensor.green() - robot.LeftColorSensor.blue() <= 450) {
                    telemetry.addData("Color", "All Yellow");
                    telemetry.update();
                    robot.LEDServo.setPosition(LED_YELLOW);
                } else if (robot.RightColorSensor.green() - robot.RightColorSensor.blue() <= 450 && robot.LeftColorSensor.green() - robot.LeftColorSensor.blue() >= 451) {
                    telemetry.addData("Color", "Right Yellow, Left White");
                    telemetry.update();
                    robot.LEDServo.setPosition(LED_RED);
                } else if (robot.RightColorSensor.green() - robot.RightColorSensor.blue() >= 451 && robot.LeftColorSensor.green() - robot.LeftColorSensor.blue() <= 450) {
                    telemetry.addData("Color", "Right White, Left Yellow");
                    telemetry.update();
                    robot.LEDServo.setPosition(LED_RED);
                } else if (robot.RightColorSensor.green() - robot.RightColorSensor.blue() >= 451 && robot.LeftColorSensor.green() - robot.LeftColorSensor.blue()>= 451) {
                    telemetry.addData("Color", "All White");
                    telemetry.update();
                    robot.LEDServo.setPosition(LED_WHITE);
                } else if (robot.RightColorSensor.green() - robot.RightColorSensor.blue() <=450){
